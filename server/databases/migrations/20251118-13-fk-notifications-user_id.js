/** 
* @file databases/migration/20251118-13-fk-notifications-user_id.js
  @description Add fk on push_notifications.user_id
...
export default {
  // 마이그레이션 롤백 시 호출되는 메소드 (스키마 생성, 수정)
  async up (queryInterface, Sequelize) {
    await queryInterface.addConstraint(tableName, options);    
  },
  // 마이그레이션 롤백 시 호출되는 메소드 (스키마 제거, 수정)
